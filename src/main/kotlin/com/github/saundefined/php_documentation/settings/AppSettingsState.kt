package com.github.saundefined.php_documentation.settings
...
@State(
    name = "com.github.saundefined.php_documentation.settings.AppSettingsState",
    storages = [Storage("PHPDocumentationSettingsPlugin.xml")]
)
